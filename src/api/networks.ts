...
export namespace networks {
    ...
    export const graphApis = {
        mumbai: {
            url: new URL("https://api.studio.thegraph.com/query/45351/dforum-mumbai/dev-1681914372")
        },
        sepolia: {
            url: new URL("https://api.studio.thegraph.com/query/45351/dforum-sepolia/dev-1681914350")
        }
    ...
    export const subgraphs = Object.fromEntries(Object.entries(networksJson).map(([key, value]) => [key, {
