import { IEternisProxy_ABI } from "@contracts/artifacts/IEternisProxy"
...
export namespace IEternisProxy {
	...
	export function connect(runner: ContractRunner, address = defaultAddress) {
		return new Contract(address, IEternisProxy_ABI).connect(
			runner,
		) as TypedContract<IEternisProxy_ABI>
	}
}
