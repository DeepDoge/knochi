export const EthereumChainSvg = (
	<svg
		...
		<path
			d="M9.9961 0L9.7776 0.7293V21.8904L9.9961 22.1046L19.9937 16.2984L9.9961 0Z"
			fill="#C0CBF6"
		/>
		...
		<path
			d="M9.9963 22.116L19.9939 16.3098L9.9963 11.845V22.116Z"
			fill="#8197EE"
		/>
