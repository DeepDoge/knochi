var Module = function (n) {
	...
	var T = [],
		...
		C = ""
	;(C = 0 !== (C = self.location.href).indexOf("blob:") ? C.substr(0, C.lastIndexOf("/") + 1) : ""),
		(o = function (n) {
	...
	var nW = {
		...
		p: function r(t, e, o, a, i, u) {
			...
			;(t = ni(t)),
										...
										return (function r(t, e, o) {
											if (t.includes("j")) {
												...
												return (
													...
													(u = o),
													(f = n["dynCall_" + a]),
													u && u.length ? f.apply(null, [i].concat(u)) : f.call(null, i)
												)
											}
				...
				(p = e - 1),
				n.hasOwnProperty(l)
					? ((void 0 === p || (void 0 !== n[l].overloadTable && void 0 !== n[l].overloadTable[p])) &&
					  ...
					  n.hasOwnProperty(p) && nd("Cannot register multiple overloads of a function with the same number of arguments (" + p + ")!"),
				...
				(function n(r, t, e) {
					...
					return (
						...
						(a = (function n(r, t, e, o, a) {
							...
							for (var s = "void" !== t[0].name, l = "", v = "", c = 0; c < i - 2; ++c)
								(l += (0 !== c ? ", " : "") + "arg" + c), (v += (0 !== c ? ", " : "") + "arg" + c + "Wired")
							var p =
								"return function " +
								ns(r) +
								"(" +
							...
							for (var c = 0; c < i - 2; ++c)
								(p += "var arg" + c + "Wired = argType" + c + ".toWireType(" + d + ", arg" + c + "); // " + t[c + 2].name + "\n"),
									h.push("argType" + c),
									g.push(t[c + 2])
							if (
								(u && (v = "thisWired" + (v.length > 0 ? ", " : "") + v),
								(p += (s ? "var rv = " : "") + "invoker(fn" + (v.length > 0 ? ", " : "") + v + ");\n"),
								f)
							)
							...
							return (
								s && (p += "var ret = retType.fromWireType(rv);\nreturn ret;\n"),
								(p += "}\n"),
								h.push(p),
								(function n(r, t) {
						...
						void 0 !== n[o].overloadTable && void 0 !== f ? (n[o].overloadTable[f] = a) : ((n[o] = a), (n[o].argCount = f)),
						[]
					)
				})
		},
		...
		c: function n(r, t, e) {
			...
			;(e = ni(e)), nm(r, { name: e, fromWireType: a, argPackAdvance: 8, readValueFromPointer: a }, { ignoreDuplicateRegistrations: !0 })
		},
		k: function n(r, t) {
								...
								? function () {
										return (function n(r) {
											for (var t = 0, e = 0; e < r.length; ++e) {
												...
												o >= 55296 && o <= 57343 && (o = (65536 + ((1023 & o) << 10)) | (1023 & r.charCodeAt(++e))),
													o <= 127 ? ++t : o <= 2047 ? (t += 2) : o <= 65535 ? (t += 3) : (t += 4)
											}
											return t
										})(r)
								  }
		...
		o: function n(r, t) {
			;(t = ni(t)), nm(r, { isVoid: !0, name: t, argPackAdvance: 0, fromWireType: function () {}, toWireType: function (n, r) {} })
		},
		e: nw,
		l: function n(r) {
			var t, e
	...
	!(function r() {
		...
		if ((Y++, n.monitorRunDependencies && n.monitorRunDependencies(Y), n.instantiateWasm))
			try {
		...
		return (
			(f || "function" != typeof WebAssembly.instantiateStreaming || X(nr) || "function" != typeof fetch
				? i(a)
	...
	function nO(t) {
		if (((t = t || T), !(Y > 0)))
			!(function r() {
				if (n.preRun) for ("function" == typeof n.preRun && (n.preRun = [n.preRun]); n.preRun.length; ) L(n.preRun.shift())
				ne(z)
			})(),
				!(Y > 0) &&
					(n.setStatus
		...
		function e() {
			!_ &&
				...
				F ||
					...
					(function r() {
						if (n.postRun) for ("function" == typeof n.postRun && (n.postRun = [n.postRun]); n.postRun.length; ) J(n.postRun.shift())
						ne(N)
					})()))
		}
	}
...
addEventListener("message", async (a) => {
	if (a.data.image) {
		...
		let e = await a.data.canvas.convertToBlob({ type: "image/" + a.data.imageType })
